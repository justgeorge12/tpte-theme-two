 ...
 *
 * Διοικητικό Προσωπικό του Τμήματος Πολιτισμικής Τεχνολογίας και Επικοινωνίας.
	...
	<section class="tp-leadership-area grey-bg pt-120 pb-100">
		<div class="container">
			<div class="row">
				...
				$idx    = 0;
				foreach ( tpte_all_staff()['admin-staff'] ?? [] as $member ) :
					$delay       = $delays[ $idx % 4 ];
					$profile_url = esc_url( add_query_arg( array( 'dept' => 'admin-staff', 'member' => $member['slug'] ), $single_url ) );
					$idx++;
				?>
