 ...
 *
 * Renders the News blog-list design with the shared blog sidebar, matching home.php.
 * Covers category/tag/date/author archives via the template hierarchy.
 *
            ...
            <div class="col-lg-8">
                <div class="tp-postbox-wrapper">
                    ...
                    if ( have_posts() ) :
                        ...
                        ?>
                        <p><?php esc_html_e( 'Δεν βρέθηκαν δημοσιεύσεις.', 'tpte' ); ?></p>
                        <?php
                    endif;
                    ?>
                </div>
