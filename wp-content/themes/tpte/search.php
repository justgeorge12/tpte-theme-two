 ...
 *
 * Renders the News blog-list design with the shared blog sidebar. The sidebar search
 * form scopes results to posts (hidden post_type=post), so this lists news only.
 *
                ...
                <div class="tp-postbox-wrapper">
                    ...
                    if ( have_posts() ) :
                        ...
                        <p>
                            ...
                            printf( esc_html__( 'Δεν βρέθηκαν αποτελέσματα για: %s', 'tpte' ), '<strong>' . esc_html( get_search_query() ) . '</strong>' );
                            ?>
                        </p>
                        <?php
                    endif;
