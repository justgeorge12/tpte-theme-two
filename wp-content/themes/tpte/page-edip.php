<?php
/**
 * Template Name: EDIP Staff
 * Template Post Type: page
 *
 * Εργαστηριακό Διδακτικό Προσωπικό (Ε.ΔΙ.Π.) του Τ.Π.Τ.Ε.
	...
	<section class="tp-leadership-area grey-bg pt-120 pb-100">
		<div class="container">
			<div class="row">
				...
				$idx    = 0;
				foreach ( tpte_all_staff()['edip'] as $member ) :
					$delay       = $delays[ $idx % 4 ];
					$profile_url = esc_url( add_query_arg( array( 'dept' => 'edip', 'member' => $member['slug'] ), $single_url ) );
					$idx++;
				?>
